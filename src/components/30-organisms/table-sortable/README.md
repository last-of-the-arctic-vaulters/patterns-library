...
| `model="{}"`        | Sets the model from which the component should render. See the example below.                                                                                                                        | `datesortcolumnindex="3,4"` | Sets the index of colums, which should be sorted as a date. Dates in the model _must_ be in the format `dd-mm-yyyy`, `dd/mm/yyyy` or `dd.mm.yyyy`. Multiple indices may be specified, separated by comma. |
